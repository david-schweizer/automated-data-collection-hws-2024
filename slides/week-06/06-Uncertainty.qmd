...
-   Let's continue with the exercise from last session! If you have already finished the exercise, you can follow a new task with ESS data (see next slide)

-   Create a Quarto document and render to HTML. Give it a title and include your name as author. Do not show the code, but only the final plots. Give the plot captions and describe the output with a few sentences.

-   Also, test the various code chunk options!

## ESS Task

-   Get the German data from ESS wave 5 onwards [here](https://ess.sikt.no/en/data-builder/?tab=round_country).

-   Next, identify the "trust" variables, for example "trust in country's parliament", "trust in European parliament". Use the Search function or have a look at the questionnaires.

-   The goal is to generate the mean of those trust variables at the regional level! Hint: There is a region variable in the ESS data!

-   Choose an appropriate way to plot these mean values.

-   Can you extend the analysis to other countries?
