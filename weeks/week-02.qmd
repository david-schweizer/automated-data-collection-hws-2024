...
You can download the exercise for today's session [**here**](https://ilias.uni-mannheim.de/goto.php?target=file_1552259_download&client_id=ILIAS).

The solution to the exercise can be found [**here**](https://ilias.uni-mannheim.de/goto.php?target=file_1553894_download&client_id=ILIAS).
